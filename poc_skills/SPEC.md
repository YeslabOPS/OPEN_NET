...
| **后端框架** | Node.js 20 + Express / Fastify | 高性能 JavaScript 运行时 |
...
| 技术 | 优势 |
|------|------|
| **Node.js** | 前后端统一语言，降低学习成本；生态丰富，异步 I/O 适合高并发 |
| **Express/Fastify** | 轻量灵活，快速构建 RESTful API |
| **Prisma** | 类型安全的 ORM，数据库迁移方便，支持多种数据库 |
| **Zod** | 运行时类型验证，与 TypeScript 完美配合 |
